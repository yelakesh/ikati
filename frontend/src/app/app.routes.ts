...
export const routes: Routes = [
    ...
    { path: "home/:accion/:filtro1", component: HomeComponent, data: { breadcrumb: 'Inicio' } },
    { path: "home/:accion/:filtro1/:filtro2", component: HomeComponent, data: { breadcrumb: 'Inicio' } },
